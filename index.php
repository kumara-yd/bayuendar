...
$file = file_get_contents(".env", true) or die("Unable to get content!");
$file = explode("\n", $file);
$env = new stdClass();
$env->kepada = $_GET['to'] ?? "Nama Tamu";
...
<head>
	...
	<title><?= $env->title ?? "The Wedding of Pria & Wanita" ?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="The Wedding of <?= $env->menShort . " dan " . $env->womenShort ?>" />
	<meta name="keywords" content="wedding, wedding invitation, invitation, the wedding" />
	<meta name="author" content="<?= $env->menShort . " & " . $env->womenShort ?>" />

	<!-- Facebook and Twitter integration -->
	<meta property="og:type" content="website">
	<meta property="og:title" content="The Wedding of <?= $env->menShort . " dan " . $env->womenShort ?>" />
	...
	<meta property="og:site_name" content="The Wedding of <?= $env->menShort . " dan " . $env->womenShort ?>" />
	<meta property="og:description" content="The Wedding of <?= $env->menShort . " dan " . $env->womenShort ?>. Open source wedding invitation" />

	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@ngodingsolusi" />
	<meta name="twitter:creator" content="@ngodingsolusi" />
	<meta name="twitter:title" content="The Wedding of <?= $env->menShort . " dan " . $env->womenShort ?>" />
	<meta name="twitter:description" content="Open Source Wedding Invitation. The Wedding of <?= $env->menShort . " dan " . $env->womenShort ?>" />
...
<body>
		...
		<div id="floating-button" class="float">
			<div class="control-center open">
				<div class="audio-play">
					<div data-video="<?= $env->ytSound ?? "QZng89VxKWg" ?>" data-autoplay="0" data-loop="1" id="youtube-audio1"></div>
				</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
							<h1><?= $env->menShort . " & " . $env->womenShort ?></h1>
							<p style="margin-bottom: 0">Kepada Bapak/Ibu/Saudara/i</p>
							<p style="margin-bottom: 0"><?= $env->kepada ?></p>
				...
				<div class="couple-wrap animate-box">
					<div class="couple-half">
						...
						<div class="desc-groom">
							<h3><?= $env->womenFull ?? "Putri" ?></h3>
							<p><span style="color: #bf9b73">Putri <?= $env->womenTo ?? "Pertama" ?> dari</span><br>
								<span class="parents-font">Bapak <?= $env->womenFather ?? "Ayah" ?></span>
								<br>
								<span class="parents-font">Ibu <?= $env->womenMother ?? "Ibu" ?></span>
							</p>
							<div id="social-media-rehan">
								<ul class="fh5co-social-icons">
									<li><a target="_blank" href="#"><i class="icon-github-with-circle"></i></a></li>
									<li><a target="_blank" href="#"><i class="icon-linkedin-with-circle"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="couple-half">
						...
						<div class="desc-bride">
							<h3><?= $env->menFull ?? "Putra" ?></h3>
							<p><span style="color: #bf9b73">Putra <?= $env->menTo ?? "Pertama" ?> dari</span><br>
								<span class="parents-font">Bapak <?= $env->menFather ?? "Ayah" ?></span>
								<br>
								<span class="parents-font">Ibu <?= $env->menMother ?? "Ibu" ?></span>
							</p>
							<div id="social-media-molid">
								<ul class="fh5co-social-icons">
									...
									<li><a target="_blank" href="#"><i class="icon-twitter-with-circle"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="col-md-6 col-sm-6 text-center">
							<div class="event-wrap animate-box">
								...
								<div class="event-col">
									...
									<span><?= $env->akadTimeStart ?? "00:00" ?></span>
									<span><?= $env->akadTimeEnd ?? "selesai" ?></span>
								</div>
								<div class="event-col">
									<i class="icon-calendar"></i>
									<span><?= $env->akadDay ?? "Ahad" ?></span>
									<span class="tanggal"><?= $env->akadDate ?? "1 Januari 2023" ?></span>
								</div>
								<p style="font-family: 'Courgette', Arial, serif">Alamat : <?= $env->akadAddress ?? "Alamat" ?></p>

								<a href="<?= $env->akadMap ?? "#" ?>" target="_blank" class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 text-center">
							<div class="event-wrap animate-box">
								<h3 style="font-family: 'Oswald', Arial, serif;"><?= $env->resepsiType ?? "Walimatul 'Ursy" ?></h3>
								<div class="event-col">
									<i class="icon-clock"></i>
									<span><?= $env->resepsiTimeStart ?? "00:00" ?></span>
									<span><?= $env->resepsiTimeEnd ?? "selesai" ?></span>
								</div>
								<div class="event-col">
									<i class="icon-calendar"></i>
									<span><?= $env->resepsiDay ?? "Ahad" ?></span>
									<span class="tanggal"><?= $env->resepsiDate ?? "1 Januari 2023" ?></span>
								</div>
								<p style="font-family: 'Courgette', Arial, serif">Alamat : <?= $env->resepsiAddress ?? "Alamat" ?></p>
								<!-- https://goo.gl/maps/c8UZnR3s92rDSDEp8 -->
								<a href="<?= $env->resepsiMap ?? "#" ?>" target="_blank" class="btn btn-primary">Penunjuk Lokasi <i class="icon-map2"></i></a>
							</div>
						</div>
						<div class="col-md-12 animate-box" style="margin-top: 15px;">
							...
							<iframe src="https://maps.google.com/maps?q=masjid%20baitulmuhlisin%20kadipaten&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="fh5co-gallery" style="background: url('images/background/repeat-background/so-white.png'); background-repeat:repeat ">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						<h2>Galeri Foto</h2>
						<h3 style="color: #bf9b73">Pre Wedding</h3>
					</div>
				</div>
				...
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2">
						...
						<form method="post" action="pesan.php">
							...
							<div>
								<input type="text" class="form-control " name="nama" id="nama" placeholder="Nama" value="<?= $env->kepada ?? "" ?>">
							</div>
							<div>

								<textarea name="pesan" id="pesan" cols="50" rows="4" class="form-control " placeholder="Pesan"></textarea>
							</div>
							<div>

								<textarea name="alamat" id="alamat" cols="50" rows="3" class="form-control " placeholder="Alamat"></textarea>
							</div>
							<div>
								<select name="kehadiran_st" class="form-control">
									<option disabled="disabled" selected="">Kehadiran</option>
									<option value="0">Tidak Hadir</option>
									<option value="1">Hadir</option>
									<option value="0">Pada Bae Nikahan :D</option>
								</select>
							</div>

							<div id="button-send" class="text-center animate-box" style="margin-top: 10px;">
			...
			<div class="container">
				...
				<div class="row copyright animate-box">
					<div class="col-md-12 text-center">
						...
						<br>
						<h1 style="font-family: 'Satisfy', Arial, serif"><?= $env->menShort . " & " . $env->womenShort ?></h1>
						<p>
						<ul class="fh5co-social-icons">
	...
	<script>
		...
		// ucapan
		$.get("http://localhost/php8/wedding/bayu/pesan.php?pesan=1", function(data) {
